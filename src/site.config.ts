...
const config: SiteConfig = {
  ...
  socialCardAvatarImage: './src/content/spiral.jpg',
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/c-2quared',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/c-2quared',
    // mastodon: 'https://github.com/stelcodes/multiterm-astro',
    email: 'c_2quared@pm.me',
  ...
  giscus: {
    ...
    categoryId: 'DIC_kwDORKXivs4C1_Bf',
